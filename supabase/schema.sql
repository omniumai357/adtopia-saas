...
-- Insert sample data
INSERT INTO public.packages (name, description, price_cents, features) VALUES
('Preview', 'See your QR code in action', 2900, '["QR Code Generation", "24h Delivery", "Email Support"]'),
('Full Package', 'Complete setup + 3 months support', 29700, '["QR Code Generation", "Custom Design", "3 Months Support", "Analytics Dashboard", "Priority Support"]');
